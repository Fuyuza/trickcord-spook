  ...
  try:
    ...
    if check != True:
      try:
        ...
        embed.add_field(name='Earn Coins', value="You have to keep the chat active and chating with your friend for each 2 messages you will get 1 coin to buy a house you will need 10 coins to buy for more info check !h
      except Exception:
        pass 
    else:
